...
//>>built
define("esri/layers/GraphicsLayer", "dojo/_base/declare dojo/_base/connect dojo/_base/lang dojo/_base/array dojo/dom-attr dojo/dom-construct dojo/dom-style dojox/gfx dojox/gfx/matrix ./layer ../kernel ../lang ../sniff ../Color ../domUtils ../symbols/MarkerSymbol ../symbols/SimpleMarkerSymbol ../geometry/Point ../geometry/ScreenPoint ../geometry/Extent ../geometry/mathUtils ../geometry/screenUtils ../PluginTarget".split(" "), function (x, v, w, n, J, O, H, A, u, U, K, P, D, V, E, W, y, Q, L, B, R, M, X) {
    var I, N = -1 !== A.renderer.toLowerCase().indexOf("svg"),
        F = -1 !== A.renderer.toLowerCase().indexOf("canvas"), t = 9 > D("ie"), S = D("esri-touch"), T = x(null, {
            declaredClass: "esri.layers._GraphicsContainer", _setMap: function (a, b) {
                var c, e = this._connects = [];
                this._map = a;
                F ? (c = O.create("div", {style: "overflow: visible; position: absolute;"}, b), this._surface = {
                    ...
                    I.prototype._canvas = !0) : (c = (this._surface = A.createSurface(b, a.width, a.height)).getEventSource(), H.set(c = t ? c.parentNode : c, {
                    overflow: "visible",
                    position: "absolute"
                }));
                ...
                var b = this._map;
                a.screenPoint = new L(a.pageX - b.position.x, a.pageY - b.position.y);
            ...
            _canvasUpHandler: function (a) {
            ...
            }, _tolerance: 15, _isPrimaryMatch: function (a, b, c, e) {
                if (!a.visible || !b)return !1;
                var d = b.getTransformedBoundingBox(), g;
                return d ? (g = new B(d[0].x, d[0].y, d[2].x, d[2].y), delete g.spatialReference, S ? g.intersects(c) : g.contains(e)) : n.some(b.children || [], function (a) {
                ...
                if (this._downPt &&
                    ...
                    this._processEvent(a);
                    var b = this._map, c = n.map(b.graphicsLayerIds, function (a) {
                        return b.getLayer(a)
                    });
                    c.push(b.graphics);
                    c.reverse();
                    ...
                    }), e = a.screenPoint, d = this._tolerance, g = e.x - d, f = e.y + d, h = e.x + d, d = e.y - d, k = new B(g, d, h, f), g = b.toMap(new L(g, f)), h = b.toMap(new L(h, d)), f = g.spatialReference._getInfo(), l = new B(B.prototype._normalizeX(g.x, f).x, g.y, B.prototype._normalizeX(h.x,
                        f).x, h.y, g.spatialReference), m;
    ...
    I = x(U, {
        ...
        _eventMap: {"graphic-add": ["graphic"], "graphic-remove": ["graphic"], "renderer-change": ["renderer"]},
        constructor: function (a, b) {
            if (a && (w.isString(a) || w.isObject(a) && (a.layerDefinition || a.query)))a = b;
            this._params = w.mixin({displayOnPan: !0, drawMode: !0, styling: !0}, a || {});
            var c = this._params.dataAttributes;
            "string" === typeof c && (c = [c]);
            this.styling = N ? this._params.styling : !0;
            this.dataAttributes = c;
            this.infoTemplate = a && a.infoTemplate;
            this.graphics = [];
            this._draw = w.hitch(this, this._draw);
            this._refresh =
                w.hitch(this, this._refresh);
        ...
        _setMap: function (a, b) {
            ...
            this._canvas ? (b = A.createSurface(b.getEventSource(), a.width, a.height), H.set(b.rawNode, "position", "absolute"), this._div = b.createGroup(), this._renderProto = this._div.constructor.prototype._render,
                this._div._render = w.hitch(this, this._canvasRender)) : this._div = b.createGroup();
        ...
        _unsetMap: function (a, b) {
            ...
            this._canvas ? (b = this._div.getParent(), b._parent = {}, O.destroy(b.rawNode), b.destroy()) : (this._div.clear(), b.remove(this._div), O.destroy(this._div.getEventSource()));
            this._map = this._div =
                null;
        ...
        _onExtentChangeHandler: function (a, b, c, e) {
            ...
            c ? (a = this._map.__visibleRect, b = this._div, this._evalSDRenderer(), this._refresh(!0), b.setTransform(u.translate({
                x: a.x,
                y: a.y
            })), this._renderProto && b.surface.pendingRender ? this._dirty = !0 : this.suspended || E.show(b.getEventSource())) : this._resized &&
        ...
        _refresh: function (a) {
            var b = this.graphics, c = b.length, e, d = this._draw;
        ...
        _onPanHandler: function (a, b) {
            ...
            this._div.setTransform(u.translate({x: c.x + b.x, y: c.y + b.y}))
        },
        _onPanEndUpdateHandler: function (a, b) {
            if (!this._params._child && (b.x !== this._panDx || b.y !== this._panDy)) {
                var c = this._map.__visibleRect;
                this._div.setTransform(u.translate({x: c.x, y: c.y}))
            }
            this._refresh(!1);
        ...
        _onPanEndHandler: function () {
            var a = this._map.__visibleRect, b = this._div;
            b.setTransform(u.translate({x: a.x, y: a.y}));
            this._refresh(!1);
            this._renderProto &&
            b.surface.pendingRender ? this._dirty = !0 : E.show(b.getEventSource());
            if (this.graphics.length)this.onUpdate()
        },
        onSuspend: function () {
            this.inherited(arguments);
        ...
        onResume: function (a) {
            ...
            this._wakeTimer = this._wakeTimer || setTimeout(w.hitch(this, function () {
                this.suspended || this._onExtentChangeHandler(null,
                    null, !0)
            }), 0)
        },
        _enableDrawConnectors: function () {
            var a = this._map, b = v.connect;
            this._disableDrawConnectors();
        ...
        _updateExtent: function (a) {
            ...
            if (b) {
                if (!(a._extent = b.getExtent())) {
                    var c, e;
                    if ("esri.geometry.Point" === b.declaredClass)c = b.x, e = b.y; else if ("esri.geometry.Multipoint" === b.declaredClass)c = b.points[0][0], e = b.points[0][1]; else {
                        a._extent = null;
                        return
                    }
        ...
        _intersects: function (a, b, c) {
            var e = a.spatialReference, d = b.spatialReference, g = e && d && !e.equals(d) && e._canProject(d) && 4326 === d.wkid;
            if (this._wrap && !c) {
                c = [];
                var e = a._getFrameWidth(), f = this._srInfo, h = a._clip ? a._getAvailExtent() :
                    a.extent, k, l, m, q, p = [];
                k = b._partwise;
                ...
                for (g = b.length; d < g; d++) {
                    m = b[d];
                    f = 0;
                    for (h = a.length; f < h; f++)if (q = a[f], q.extent.intersects(m.extent)) {
                        k = 0;
            ...
            return (g ? a.geographicExtent : a.extent).intersects(b) ?
                [0] : null
        },
        _defaultMarker: {type: "simplemarkersymbol", style: "square", size: 1, xoffset: 0, yoffset: 0, angle: 0},
        _draw: function (a, b) {
            if (this._params.drawMode && this._map && !this.suspended)try {
                var c = a._extent, e, d, g = !N || this.styling, f = N && this.dataAttributes, h = a.getDojoShape(), k;
                if (a.visible && c && (e = this._intersects(this._map, c, a.geometry._originOnly)) && (d = g ? this._getSymbol(a) : this._defaultMarker)) {
                    if (!a._offsets || a._offsets.join(",") !== e.join(",") ? a._offsets = e : k = !0, !h || b || !k) {
                        var l = a.geometry.type, c = {graphic: a},
                            m = a._bgShape, q = g && !a.symbol ? this._getRenderer(a) : null, p = q && q.backgroundFillSymbol;
                        if ("point" === l)this._isInvalidShape(d, h) && this._removeShape(a), a._shape = this._drawPoint(this._div, a.geometry, d, a.getDojoShape(), e, q, a), g && this._symbolizePoint(a.getDojoShape(), d, q, a); else if ("multipoint" === l)this._drawMarkers(a, d, e, q), g && this._symbolizeMarkers(a, d, q); else {
                            var n, l = d, C, G;
                            g && (l = (n = d.isInstanceOf(W) ? d : null) ? p : d);
                            l && l === p && (C = this._bgGroup);
                            m && !C && this._removeBgShape(a);
                            l && (!C && this._isInvalidShape(l, a._shape) &&
                            this._removeShape(a, !1), G = this._drawShape(a, e, C || this._div, C ? m : a.getDojoShape()), g && this._symbolizeShape(G, l, !p && q, a), a[C ? "_bgShape" : "_shape"] = G);
                            n && (this._isInvalidShape(n, a._shape) && this._removeShape(a, !1), G = this._drawPoint(this._div, a.geometry.getCentroid(), n, a._shape, e, q, a), this._symbolizePoint(G, n, q, a), a._shape = G)
                        }
                        F || (a._bgShape && this._initNode(a, a._bgShape, a._bgShape !== m, c, f), a._shape && this._initNode(a, a._shape, a._shape !== h, c, f));
                        c.node = a.getNode();
        ...
        _removeShape: function (a, b) {
            var c = a.getDojoShape(), e = c && c.getNode();
            c && (c.removeShape(), c.destroy());
            a._shape = a._offsets = null;
            !1 !== b && this._removeBgShape(a);
            if (e && (e.e_graphic = null, !F))this.onGraphicNodeRemove({graphic: a, node: e})
        },
        _removeBgShape: function (a) {
            var b = a._bgShape, c = b && b.getNode();
            b && (b.removeShape(), b.destroy(), a._bgShape = null);
            if (c && (c.e_graphic = null, !F))this.onGraphicNodeRemove({
                graphic: a,
                node: c
            })
        },
        _addDataAttrs: function (a, b, c) {
            var e = a.attributes, d, g = b ? b.length : 0, f = this._getRenderer(a);
            if (c && e) {
        ...
        _drawShape: function (a, b, c, e) {
            a = a.geometry;
            var d = a.type, g = this._map, f = g.extent, h = g.width, k = g.height, g = g.__visibleRect, l = [], m, q;
            m = "extent" === d;
            if ("rect" ===
                d || m)l = {
                x: 0,
            ...
            }, l.x = m ? a.xmin : a.x, l.y = m ? a.ymax : a.y, d = M.toScreenPoint(f, h, k, l), l.x = m ? a.xmax : a.x + a.width, l.y = m ? a.ymin : a.y + a.height, a = M.toScreenPoint(f, h, k, l), b = {
                x: d.x - g.x + b[0],
                y: d.y - g.y,
                width: Math.abs(a.x - d.x),
                height: Math.abs(a.y - d.y)
            }, 0 === b.width && (b.width = 1), 0 === b.height && (b.height = 1), e = this._drawRect(c, e, b); else if ("polyline" === d || "polygon" === d) {
                m = 0;
                for (q = b.length; m < q; m++)l = l.concat(M._toScreenPath(f, h, k, a, -g.x + b[m], -g.y));
        ...
        _evalSDRenderer: function (a) {
            var b = this._map, c = this.renderer, e, d = this._rndForScale;
            ...
            !a && this._rndForScale != d && this.emit("renderer-change", {renderer: this._rndForScale})
        },
        ...
        _applyOpacity: function (a, b, c, e) {
            b = b.getOpacity(e, {opacityInfo: c});
            null != b && (a = new V(a), a.a = b);
            return a
        },
        _symbolizeShape: function (a, b, c, e) {
            var d = b.getStroke(), g = b.getFill();
            b = b.type;
            var f, h, k = this._getVariable(c, "sizeInfo"), l = this._getVariable(c,
                "colorInfo"), m = this._getVariable(c, "opacityInfo"), k = k ? c.getSize(e, {
                sizeInfo: k,
                resolution: this._map.getResolutionInMeters()
            }) : null;
            if (c && (l || m) && "picturefillsymbol" !== b)-1 !== b.indexOf("linesymbol") ? (f = d && d.color, l && (f = c.getColor(e, {colorInfo: l}) || f), f && m && (f = this._applyOpacity(f, c, m, e))) : g && g.toCss && (h = g, l && (h = c.getColor(e, {colorInfo: l}) || h), h && m && (h = this._applyOpacity(h, c, m, e)));
            a.setStroke(null == k && !f ? d : w.mixin({}, d, k && {width: k}, f && {color: f})).setFill(h || g)
        },
        _smsToPath: function () {
            return t ? function (a,
                                 b, c, e, d, g, f, h, k) {
        ...
        _pathStyles: {
            square: 1,
            cross: 1, x: 1, diamond: 1, target: 1
        },
        _typeMaps: {
        ...
        _isInvalidShape: function (a, b) {
            var c = b && b.shape && b.shape.type, e = a && a.type, d = a && a.style;
            "rect" === c && (c = "path");
        ...
        _drawPoint: function (a, b, c, e, d, g, f) {
            var h = c.type, k = this._map, l = k.__visibleRect, m = M.toScreenPoint(k.extent,
                k.width, k.height, b).offset(-l.x + d[0], -l.y), l = m.x, q = m.y, p;
            b = [];
            var n = g && g.rotationInfo ? g.getRotationAngle(f) : null, C = this._getVariable(g, "sizeInfo");
            g = C ? g.getSize(f, {sizeInfo: C, shape: c.style, resolution: k.getResolutionInMeters()}) : null;
            ...
            if ("simplemarkersymbol" === h)switch (p = c.style, h = Math.round, g = null != g ? g : c.size, p) {
                ...
                case y.STYLE_CROSS:
                case y.STYLE_X:
                case y.STYLE_DIAMOND:
                    c =
                        isNaN(g) ? 16 : g / 2;
                    p = this._drawPath(a, e, this._smsToPath(y, p, l, q, h(l - c), h(l + c), h(q - c), h(q + c)));
                    break;
                case y.STYLE_TARGET:
                    m = c._targetWidth / 2;
                    g = c._targetHeight / 2;
                    p = this._drawPath(a, e, this._smsToPath(y, p, l, q, h(l - m), h(l + m), h(q - g), h(q + g), c._spikeSize));
                    break;
                case y.STYLE_PATH:
            ...
            "textsymbol" === h && (p = this._drawText(a, e, {
                ...
                rotated: c.rotated,
                kerning: c.kerning
            }), N && (a = p.getNode(), l = c.getSVGBaseline(), c = c.getSVGBaselineShift(), a && (a.setAttribute("dominant-baseline", l), c && a.setAttribute("baseline-shift", c))));
            p.setTransform(u.multiply(b));
            p._wrapOffsets = d;
            return p
        },
        _getScaleMatrix: function (a, b) {
            var c = a.width / a.height, e = 1, d = 1;
        ...
        _symbolizePoint: function (a, b, c, e) {
            ...
            if (!("shieldlabelsymbol" === d || "picturemarkersymbol" === d)) {
                var g;
                if ("textsymbol" === d)a.setFont(b.font).setFill(b.getFill()); else {
                    g = b.getStroke();
                    b = b.getFill();
                    if (c) {
                        var f = this._getVariable(c, "colorInfo"), h = this._getVariable(c, "opacityInfo");
                        f && (b = c.getColor(e, {colorInfo: f}) || b);
        ...
        _drawMarkers: function (a, b, c, e) {
            var d = a.geometry,
                g = d.points, f = a.getDojoShape() || this._div.createGroup(), h, k, l = g.length, m = [], q = 0, p, n = c ? c.length : 0;
            ...
            b = f.children.length;
            if (l * c.length < b)for (k = b - 1; k >= l * c.length; k--)f.children[k].removeShape();
            a._shape = f
        },
        _symbolizeMarkers: function (a, b, c) {
            var e = a.getDojoShape().children, d, g = e.length;
        ...
        _rendererLimits: function () {
            var a, b, c;
            D("ff") ? (a = 16125, b = -32250, c = 32250) : t ? (a = 1E5, b = -1E5, c = 1E5) : D("chrome") && 6 > D("chrome") && (a = 8150, b = -1E4, c = 1E4);
            if (a)return {
                clipLimit: a, rangeMin: b, rangeMax: c, clipBBox: [-a, -a, a, a], clipSegments: [[[-a, -a], [a,
                    -a]], [[a, -a], [a, a]], [[a, a], [-a, a]], [[-a, a], [-a, -a]]]
            }
        }(),
        _clipPolyline: function (a, b) {
            var c = this._getCorners(a, b), e = c.br, d = this._rendererLimits, g = d.rangeMin, f = d.rangeMax, h = d.clipBBox, k = d.clipSegments, d = this._isPointWithinRange, l = this._isPointWithinBBox, m = this._getClipperIntersection, q = this._getPlaneIndex;
            if (!d(c.tl, g, f) || !d(e, g, f)) {
                ...
                n.forEach(a.segments, function (a) {
                    ...
                    var c = a.length, b = [], e;
                    for (e = 0; e < c; e += 2) {
                        var d = [a[e], a[e + 1]], g = [a[e + 2], a[e + 3]], f = l(d, h), n = l(g,
                            h);
                        if (f ^ n) {
        ...
        _clipPolygon: function (a, b) {
            var c = this._getCorners(a, b), e = c.br, d = this._rendererLimits, g = d.clipLimit, f = d.rangeMin, h = d.rangeMax, k = d.clipBBox,
                l = d.clipSegments, d = this._isPointWithinRange, m = this._isPointWithinBBox, q = this._getClipperIntersection, p = this._getPlaneIndex, v = R._pointLineDistance;
            if (!d(c.tl, f, h) || !d(e, f, h))t && this._createSegments(a), c = n.map(a.segments, function (a) {
                var b = a.args, c = b.length, e = [];
                a = [];
                var d;
                for (d = 0; d < c; d += 2) {
                    var f = [b[d], b[d + 1]], h = [b[d + 2], b[d + 3]];
                    if (d === c - 2) {
                        e.push(f);
                        break
                    }
                    ...
                    if (s ^ r) {
                        ...
                        var s =
                            p(f, k), z = p(h, k);
                        -1 === s || (-1 === z || s === z) || (r = q([f, h], l, !0), 0 < r.length ? (r[s] || (s = r[s[0]] ? s[0] : s[1]), r[z] || (z = r[z[0]] ? z[0] : z[1]), f = r[s], h = r[z], f && (f.outIn = !0, e.push(f), a.push(["OUTIN", e.length - 1, s])), h && (h.inOut = !0, e.push(h), a.push(["INOUT", e.length - 1, z]))) : w.isArray(s) && w.isArray(z) && (r = s.concat(z), r.sort(), "0123" === r.join("") && (r = [], 3 === s[0] + s[1] ? r.push([g, -g], [-g, g]) : r.push([-g, -g], [g, g]), s = v(r[0], [f, h]), f = v(r[1], [f, h]), e.push(s < f ? r[0] : r[1]))))
                    }
                }
                var t = k[0], u = k[1], x = k[2], y = k[3];
                n.forEach(e, function (a) {
                    a[0] <
                    t && (a[1] >= u && a[1] <= y ? a[0] = t : (a[0] = t, a[1] = a[1] < u ? u : y))
                });
                n.forEach(e, function (a) {
                    a[1] < u && (a[0] >= t && a[0] <= x ? a[1] = u : (a[1] = u, a[0] = a[0] < t ? t : x))
                });
                n.forEach(e, function (a) {
                    a[0] > x && (a[1] >= u && a[1] <= y ? a[0] = x : (a[0] = x, a[1] = a[1] < u ? u : y))
                });
                n.forEach(e, function (a) {
                    a[1] > y && (a[0] >= t && a[0] <= x ? a[1] = y : (a[1] = y, a[0] = a[0] < t ? t : x))
                });
                b = 0;
                c = a.length;
                if (0 < c) {
                    do {
                        h = a[b];
                        d = a[(b + 1) % c];
                        if (h[2] === d[2] && "INOUT" === h[0] && "OUTIN" === d[0])if (f = h[1], d = d[1], f < d)for (f += 1; f < d; f++)e[f][2] = !0; else if (f > d) {
                ...
                c[2] && (b[2] = !0, n.some(a, function (a) {
                    return 1 === a[1] ? (e.splice(e.length - 1, 0, w.clone(e[1])), !0) : !1
                }));
                e = n.filter(e, function (a) {
                    return a[2] ? !1 : !0
                });
                for (b = 0; b < e.length - 1; b++)if (c = e[b], (d = e[b + 1]) && !(c[0] !== d[0] || c[1] !== d[1]))d.outIn ? c.outIn = !0 : d.inOut && (c.inOut = !0), e.splice(b + 1, 1);
                c = Math.abs;
                a = [];
        ...
        _getCorners: function (a, b) {
            if (t) {
                var c = this._map, e = b.getExtent(), d = e.spatialReference, g = c.toScreen(new Q(e.xmin, e.ymax, d)), c = c.toScreen(new Q(e.xmax, e.ymin, d));
                return {tl: g, br: c}
            }
            g = a.getTransformedBoundingBox();
            return {tl: g[0], br: g[2]}
        },
        ...
        _isPointWithinBBox: function (a, b) {
            var c = b[1], e = b[2], d = b[3], g = a[0], f = a[1];
        ...
        _getClipperIntersection: function (a, b, c) {
            var e, d = R._getLineIntersection2, g = Math.round, f = {length: 0};
            for (e = 0; 4 > e; e++) {
                var h = d(a, b[e]);
                if (h)if (h[0] = g(h[0]), h[1] = g(h[1]), c)f[e] = h, f.length++; else return [e, h]
            }
            return c ? f : null
        },
        _getPlaneIndex: function (a, b) {
            var c = a[0], e = a[1], d = b[0], g = b[1], f = b[2], h = b[3];
            return c <= d ? e >=
        ...
        _setIEOpacity: function (a, b) {
            var c = a && a.getNode();
            if (c) {
                var e = a.strokeStyle, d = c.stroke;
                e && d && (d.opacity = e.color.a * b);
                e = a.fillStyle;
                d = c.fill;
                e && d && ("tile" === d.type ? H.set(c, "opacity", b) : d.opacity = e.a * b)
            }
        },
        setOpacity: function (a, b) {
            if (b || this.opacity != a) {
                ...
                }, this), c._esriIeOpacity = a, this._bgGroup._esriIeOpacity = a) : this._canvas ? H.set(c.getEventSource(), "opacity", a) : c.getEventSource().setAttribute("opacity", a));
                this.opacity = a;
        ...
        setRenderer: function (a) {
            ...
            this.emit("renderer-change", {renderer: this._rndForScale || a})
        }
    });
    x = x([I, X], {
        declaredClass: "esri.layers.GraphicsLayer", constructor: function () {
            this.enableMouseEvents = w.hitch(this, this.enableMouseEvents);
            this.disableMouseEvents = w.hitch(this, this.disableMouseEvents);
            this._processEvent = w.hitch(this, this._processEvent);
            this._initLayer()
        }, _initLayer: function () {
            this.loaded = !0;
            this.onLoad(this)
        ...
        _onMouseOutHandler: function (a) {
            ...
            if (this._processEvent(a)) {
                var b = this._downGr, c = this._upGr;
                b && (c && b === c && this._downPt === this._upPt) && (t && (K._ieGraphic = a.graphic), this.onClick(a))
            }
        ...
        onMouseOver: function () {
            ...
            if (!this._mouseEvents) {
                var a = v.connect, b = this._div.getEventSource();
                F || (this._onmouseover_connect = a(b, "onmouseover", this, "_onMouseOverHandler"), this._onmousemove_connect = a(b, "onmousemove", this, "_onMouseMoveHandler"), this._onmouseout_connect = a(b, "onmouseout", this, "_onMouseOutHandler"),
    ...
    x._GraphicsContainer = T;
    x._GraphicsLayer = I;
    D("extend-esri") && (w.setObject("layers.GraphicsLayer", x, K), w.setObject("layers._GraphicsContainer", T, K), w.setObject("layers._GraphicsLayer", I, K));
    return x
});