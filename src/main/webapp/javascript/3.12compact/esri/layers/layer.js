...
//>>built
define("esri/layers/layer", "dojo/_base/declare dojo/_base/config dojo/_base/connect dojo/_base/lang dojo/_base/Deferred dojo/_base/json dojo/has ../Evented ../kernel ../lang ../request ../deferredUtils ../urlUtils ../SpatialReference ../geometry/Extent".split(" "), function (l, m, d, c, n, p, q, r, g, f, s, t, u, k, v) {
    var h = l([r], {
        ...
        constructor: function (a,
                               b) {
            if (a && c.isString(a))this._url = u.urlToObject(this.url = a); else if (this.url = this._url = null, (b = b || a) && (b.layerDefinition || b.query))b = null;
            ...
            b && (b.id && (this.id = b.id), !1 === b.visible && (this.visible = !1), f.isDefined(b.opacity) && (this.opacity = b.opacity), f.isDefined(b.minScale) && this.setMinScale(b.minScale), f.isDefined(b.maxScale) && this.setMaxScale(b.maxScale), this.attributionDataUrl =
                b.attributionDataUrl || "", this.hasAttributionData = !!this.attributionDataUrl, f.isDefined(b.showAttribution) && (this.showAttribution = b.showAttribution), this.className = b.className, this.refreshInterval = b.refreshInterval || 0);
            this._errorHandler = c.hitch(this, this._errorHandler);
            this.refresh = c.hitch(this, this.refresh);
        ...
        _getToken: function () {
            var a = this._url, b = this.credential;
            return a && a.query && a.query.token || b && b.token || void 0
        },
        _findCredential: function () {
            this.credential = g.id && this._url && g.id.findCredential(this._url.path)
        },
        _useSSL: function () {
            var a = this._url, b = /^http:/i;
        ...
        setScaleRange: function (a, b) {
            var e = f.isDefined(a), c = f.isDefined(b);
            this.loaded || (this._hasMin = this._hasMin || e, this._hasMax = this._hasMax || c);
            var d = this.minScale, g = this.maxScale;
            this.minScale = (e ? a : this.minScale) || 0;
            this.maxScale = (c ? b : this.maxScale) || 0;
            if (d !== this.minScale || g !== this.maxScale)this.onScaleRangeChange(), this._processMapScale()
        },
        suspend: function () {
            this._suspended = !0;
            this.evaluateSuspension()
        ...
        _resume: function () {
            this.suspended = !1;
            this.attr("data-suspended");
            var a = void 0 === this._resumedOnce, b = this.className, e = this.getNode();
            if (a && (this._resumedOnce = !0, b && e)) {
                var c = e.getAttribute("class") || "";
                RegExp("(^|\\s)" + b + "(\\s|$)", "i").test(c) || e.setAttribute("class", c + ((c ? " " : "") + b))
            }
            this._toggleRT(!0);
            this.onResume({firstOccurrence: a});
        ...
        isVisibleAtScale: function (a) {
            return a ? h.prototype._isMapAtVisibleScale.apply(this, arguments) : !1
        },
        _isMapAtVisibleScale: function (a) {
            if (!a && (!this._map || !this._map.loaded))return !1;
            a = a || this._map.getScale();
            var b = this.minScale, e = this.maxScale, c = !b, d = !e;
            !c && a <= b && (c = !0);
            !d && a >= e && (d = !0);
            return c && d
        },
        getAttributionData: function () {
            var a = this.attributionDataUrl, b = new n(t._dfdCanceller);
        ...
        getResourceInfo: function () {
            ...
            return c.isString(a) ? p.fromJson(a) : c.clone(a)
        },
        getMap: function () {
            return this._map
        },
    ...
    q("extend-esri") && c.setObject("layers.Layer", h, g);
    return h
});