...
//>>built
define("esri/symbols/SimpleFillSymbol", "dojo/_base/declare dojo/_base/lang dojo/_base/Color dojo/has dojox/gfx/_base ../kernel ../lang ./FillSymbol ./SimpleLineSymbol require".split(" "), function (b, d, h, k, l, f, g, m, n, p) {
    var c = {
        STYLE_SOLID: "solid",
        STYLE_NULL: "none",
    ...
    }, e = {style: c.STYLE_SOLID, color: [0, 0, 0, 0.25]};
    b = b(m, {
        declaredClass: "esri.symbol.SimpleFillSymbol",
        type: "simplefillsymbol",
        patternUrlPrefix: p.toUrl("../images/symbol/sfs/"),
        _styles: {
            solid: "esriSFSSolid",
            none: "esriSFSNull",
        ...
        constructor: function (a, b, c) {
            a ? d.isString(a) ? (this.style =
                a, void 0 !== b && (this.outline = b), void 0 !== c && (this.color = c)) : this.style = g.valueOf(this._styles, a.style) : (d.mixin(this, e), this.outline = new n(this.outline), this.color = new h(this.color))
        },
        setStyle: function (a) {
            this.style = a;
            return this
        ...
        getFill: function () {
            var a = this.style;
            return a === c.STYLE_NULL ? null : a === c.STYLE_SOLID ? this.color : d.mixin({}, l.defaultPattern, {
        ...
        getShapeDescriptors: function () {
            return {
                ...
                }, fill: this.getFill(), stroke: this.getStroke()
            }
        },
        toJson: function () {
            return g.fixJson(d.mixin(this.inherited("toJson", arguments), {
                type: "esriSFS",
    ...
    d.mixin(b, c);
    b.defaultProps = e;
    k("extend-esri") && (d.setObject("symbol.SimpleFillSymbol", b, f), f.symbol.defaultSimpleFillSymbol = e);
    return b
});