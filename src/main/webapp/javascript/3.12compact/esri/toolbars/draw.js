...
define("esri/toolbars/draw", "dojo/_base/declare dojo/_base/lang dojo/_base/array dojo/_base/connect dojo/_base/Color dojo/_base/window dojo/has dojo/sniff dojo/keys dojo/dom-construct dojo/dom-style dojo/dom-geometry ../kernel ../sniff ./_toolbar ../symbols/SimpleMarkerSymbol ../symbols/SimpleLineSymbol ../symbols/SimpleFillSymbol ../graphic ../geometry/jsonUtils ../geometry/webMercatorUtils ../geometry/Polyline ../geometry/Polygon ../geometry/Multipoint ../geometry/Rect dojo/i18n!../nls/jsapi".split(" "),
    function (G, l, y, k, w, x, p, A, H, B, C, I, J, N, K, D, u, E, r, L, M, s, q, z, F, t) {
        var h = G(K, {
            ...
            activate: function (c, a) {
                ...
                var b = this.map, d = k.connect, g = h;
                ...
                switch (c) {
                    ...
                    case g.RECTANGLE:
                        ...
                        this._onMouseDownHandler_connect =
                            d(b, this._mouse ? "onMouseDown" : "onSwipeStart", this._onMouseDownHandler);
                        ...
                        p("esri-touch") && !p("esri-pointer") && (this._onMouseDownHandler2_connect = d(b, "onMouseDown", this._onMouseDownHandler), this._onMouseDragHandler2_connect = d(b, "onMouseDrag", this._onMouseDragHandler), this._onMouseUpHandler2_connect = d(b, "onMouseUp",
                    ...
                    case g.FREEHAND_POLYGON:
                        ...
                        this._onMouseDragHandler_connect = d(b, this._mouse ? "onMouseDrag" : "onSwipeMove", this._onMouseDragHandler);
                        this._onMouseUpHandler_connect = d(b, this._mouse ? "onMouseUp" : "onSwipeEnd",
                            this._onMouseUpHandler);
                    ...
                    case g.MULTI_POINT:
                        ...
                        this._onClickHandler_connect = d(b, "onClick", this._onClickHandler);
                        this._onDblClickHandler_connect = d(b, "onDblClick",
            ...
            _drawEnd: function (c) {
                if (c) {
                    ...
                    this.onDrawEnd(c);
                    a && (a.isWebMercator() ? b = M.webMercatorToGeographic(c, !0) : 4326 === a.wkid && (b = L.fromJson(c.toJson())));
            ...
            _onMouseDownHandler: function (c) {
                ...
                switch (this._geometryType) {
                    ...
                    case d.FREEHAND_POLYGON:
                        this._oldPoint = c.screenPoint, b = new q(g), b.addRing(this._points), this._graphic = a.graphics.add(new r(b, this.fillSymbol),
            ...
            _onMouseDragHandler: function (c) {
                if (p("esri-touch") && !this._points.length)c.preventDefault();
                    ...
                    var a;
                    this.map.snappingManager && (a = this.map.snappingManager._snappingPoint);
                    var b = this._points[0], d = a || c.mapPoint, g = this.map, v = g.spatialReference;
                    a = this._graphic;
                    var k = h, m = g.toScreen(b), f = g.toScreen(d), e = [], e = f.x - m.x, f = f.y - m.y, n = Math.sqrt(e * e + f * f);
                    switch (this._geometryType) {
                        case k.CIRCLE:
                            this._hideTooltip();
                            a.geometry = q.createCircle({center: m, r: n, numberOfPoints: 60, map: g});
                        ...
                        case k.ELLIPSE:
                            ...
                            a.geometry = q.createEllipse({
                                center: m,
                                longAxis: e, shortAxis: f, numberOfPoints: 60, map: g
                            });
                            a.setGeometry(a.geometry);
                            break;
                        case k.TRIANGLE:
                            this._hideTooltip();
                            e = [[0, -n], [0.8660254037844386 * n, 0.5 * n], [-0.8660254037844386 * n, 0.5 * n], [0, -n]];
                        ...
                        case k.ARROW:
                            ...
                            v = 0.25 * n / (f / e);
                            n *= 0.25 * b;
                            e = [[e, f], [e - d * (1 + 24 / v), f + 24 * g - n], [e - d * (1 + 12 / v), f + 12 * g - n], [-12 * b, 12 * g], [12 * b, -12 * g], [e - d * (1 - 12 / v), f - 12 * g - n], [e - d * (1 - 24 / v), f - 24 * g - n], [e, f]];
                        ...
                        case k.RIGHT_ARROW:
                            this._hideTooltip();
                            e = 0 <= e ? [[e, 0], [0.75 * e, f], [0.75 * e, 0.5 * f], [0, 0.5 * f], [0, -0.5 * f], [0.75 * e, -0.5 * f], [0.75 * e, -f], [e, 0]] : [[0, 0], [0.25 * e, f], [0.25 * e, 0.5 * f],
                                [e, 0.5 * f], [e, -0.5 * f], [0.25 * e, -0.5 * f], [0.25 * e, -f], [0, 0]];
                            a.geometry = this._toPolygon(e, m.x, m.y);
                            a.setGeometry(a.geometry);
                            break;
                        case k.UP_ARROW:
                        ...
                        case k.DOWN_ARROW:
                            this._hideTooltip();
                            e = 0 <= f ? [[0, f], [-e, 0.75 * f], [-0.5 * e, 0.75 * f], [-0.5 *
                            e, 0], [0.5 * e, 0], [0.5 * e, 0.75 * f], [e, 0.75 * f], [0, f]] : [[0, 0], [-e, 0.25 * f], [-0.5 * e, 0.25 * f], [-0.5 * e, f], [0.5 * e, f], [0.5 * e, 0.25 * f], [e, 0.25 * f], [0, 0]];
                            a.geometry = this._toPolygon(e, m.x, m.y);
                            a.setGeometry(a.geometry);
                            break;
                        case k.RECTANGLE:
                            ...
                            break;
                        case k.LINE:
                            a.setGeometry(l.mixin(a.geometry, {paths: [[[b.x, b.y], [d.x, d.y]]]}));
                            break;
                        case k.EXTENT:
                ...
                if (this._dragged) {
                    ...
                    switch (this._geometryType) {
                        ...
                        case g.RECTANGLE:
                            ...
                            break;
                        case g.LINE:
                            k = new s({paths: [[[b.x, b.y], [a.x, a.y]]], spatialReference: d});
                            break;
                        case g.EXTENT:
                            k =
            ...
            _onClickHandler: function (c) {
                ...
                switch (this._geometryType) {
                    ...
                    case d.ARROW:
                        this._addShape([[0,
                            0], [-24, 24], [-24, 12], [-96, 12], [-96, -12], [-24, -12], [-24, -24], [0, 0]], b.x, b.y);
                        break;
                    case d.LEFT_ARROW:
                    ...
                    case d.UP_ARROW:
                        ...
                        break;
                    case d.DOWN_ARROW:
                        this._addShape([[0, 0], [-24, -24], [-12, -24], [-12, -96], [12, -96],
                            [12, -24], [24, -24], [0, 0]], b.x, b.y);
                        break;
                    case d.TRIANGLE:
                    ...
                    case d.CIRCLE:
                        this._clear();
                        this._drawEnd(q.createCircle({center: b, r: 48, numberOfPoints: 60, map: a}));
                        break;
                    case d.ELLIPSE:
            ...
            _toPolygon: function (c, a, b) {
                var d = this.map, g = new q(d.spatialReference);
            ...
            _toggleTooltip: function (c) {
                    this._options.showTooltips && (c ? this._tooltip || (this._tooltip = B.create("div", {"class": "tooltip"}, this.map.container), I.isBodyLtr() || C.set(this._tooltip, "direction", "rtl"), this._tooltip.style.display =
            ...
            _updateTooltip: function (c) {
                ...
                if (a) {
                    ...
                    C.set(a, {
                        left: b +
                        this._options.tooltipOffset + "px", top: c + "px"
                    });
                    a.style.display = ""
                }
            },
        ...
        p("extend-esri") && l.setObject("toolbars.Draw", h, J);
        return h
    });