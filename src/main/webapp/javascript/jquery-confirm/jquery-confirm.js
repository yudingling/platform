...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        //edit by zd, autoclose is need when confirm/cancel button are both set to false
        ...
        setDialogCenter: function (animate) {
            ...
            var topMargin = this.position == 'bottom'? (windowHeight - boxHeight - 10) : ((windowHeight - boxHeight) / 2);
            var minMargin = 100;
    ...
    jconfirm.pluginDefaults = {
        ...
        scrollEnable: false  //edit，keep the scroll bar on body
    };
