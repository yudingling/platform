  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      ...
      BootstrapSwitch.prototype._width = function() {
        ...
        //edit by zd. we assume the '_handleWidth' is the outer width of the dom node, but the original using of 'width' method set the wrong width. so we change to css
        $handles.css('width', handleWidth + 'px');
        
        var lbWidth = this.$label.width();
        if (this.options.labelWidth !== "auto") {
          lbWidth = this.options.labelWidth;
        }else if (lbWidth < this._handleWidth) {
          lbWidth = this._handleWidth;
        }
        this.$label.css('width', lbWidth + 'px');
        
        this._handleWidth = this.$on.outerWidth();
        this._labelWidth = this.$label.outerWidth();
        this.$container.css('width', ((this._handleWidth * 2) + this._labelWidth) + 'px');
          ...
          return function() {
            ...
            return _this._containerPosition(null, function() {
              ...
              if (_this.options.animate) {
                ...
                return _this.$wrapper.removeClass(_this.options.baseClass + "-animate");
              }
            });
          };
        })(this);
