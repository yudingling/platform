...
define([
    ...
    "dojo/_base/lang",
    "dojo/topic",
    "dojo/text!./template/rapidchangeana.html",
    "tool/css!./css/rapidchangeana.css"
], function(
        base,
        declare,
        _Widget,
    ...
    return declare("component.ruleMgr.widget.rapidc", [_Widget], {
        baseClass: "component_ruleMgr_widget_rapidc",
        ...
        _save: function(){
        	...
        	if(!base.isNull(saveData)){
        		base.ajax({
            		...
            		url: base.getServerNM() + 'rapidchangeana',
            		data: saveData,
