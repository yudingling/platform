...
define([
    ...
    "dojo/_base/lang",
    "dojo/topic",
    "dojo/text!./template/slowchangeana.html",
    "tool/css!./css/slowchangeana.css"
], function(
        base,
        declare,
        _Widget,
    ...
    return declare("component.ruleMgr.widget.slowc", [_Widget], {
        baseClass: "component_ruleMgr_widget_slowc",
        ...
        _save: function(){
        	...
        	if(!base.isNull(saveData)){
        		base.ajax({
            		...
            		url: base.getServerNM() + 'slowchangeana',
            		data: saveData,
