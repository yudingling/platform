...
<body class="gray-bg">
    <div class="center hvr-wobble-horizontal" style="width: 250px; height:100px; text-align: center; font-size:25px; color:#559a9a; cursor:default">
        <i class="fa fa-rocket"></i>&nbsp;&nbsp;Coming soon
    </div>
</body>
</html>