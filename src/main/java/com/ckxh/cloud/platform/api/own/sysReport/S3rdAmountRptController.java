...
@Scope("singleton")
@Controller
@RequestMapping("/own/sysReport/s3rdAmountRpt")
public class S3rdAmountRptController {
	@Autowired
	...
	public String get(@RequestParam String selTp, @RequestParam int tmLen, HttpServletRequest request, HttpServletResponse response){
		try{
			...
			statusMap.put("okCount", this.sysReportService.getThirdPartyServiceCount(ThirdPartyServiceStatus.Ok));
			statusMap.put("underReviewCount", this.sysReportService.getThirdPartyServiceCount(ThirdPartyServiceStatus.UnderReview));
			statusMap.put("disabledCount", this.sysReportService.getThirdPartyServiceCount(ThirdPartyServiceStatus.Disabled));
			statusMap.put("reliabledCount", this.sysReportService.getThirdPartyServiceReliabledCount());
			...
			Map<String, Long> statistic = this.sysReportService.getThirdPartyServiceAmountStatistic(stm_ts, etm_ts, selTp);
